...
//Background colour flash that uses JQuery plugin
...
$(function () {
    ...
    var ticker = $.connection.stockTicker, //generated client-side hub proxy, including symbols for stock ticker UI
        up = '▲',
        down = '▼',
    ...
    // Client side methods that the server can call
